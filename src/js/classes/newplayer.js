class NewPlayer {
    ...
    static rollAbilitys() {
        ...
        new Array(4).fill(0).map((element) => Dicer.roll(dices.D6))
                                                   .sort()
                                                   .splice(1, 3)
